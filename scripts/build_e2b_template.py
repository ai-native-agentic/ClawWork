...
def build_template(alias: str = "gdpval-workspace", dry_run: bool = False):
    ...
    if not e2b_installed:
        print(
            "⚠️  Note: e2b package not installed (only needed for actual template building)"
        )
...
"""
        ...
        print(
            f"4. Save the Dockerfile above to: e2b-templates/gdpval-workspace/Dockerfile"
        )
...
"""
        ...
        template_dir = os.path.join(
            os.path.dirname(__file__), "..", "e2b-templates", alias
        )
